...
### FUNCTION TO DRAW SPECIAL CASE 122AAOO #############################################################
draw.122AAOO <- function(
	a1,
	a2,
	a3,
	a4,
	...
	for (i in 1:3) {
		...
		if (0 == tmp$areas[1] & 0 == tmp$areas[3] & 0 == tmp$areas[4] & 0 == tmp$areas[5] & 0 == tmp$areas[6]) { break; }
		}
	...
	return(
		VennDiagram::draw.sp.case(
			...
			area.y = c(0, a2.y.pos, 0, 0, 0, 0, a7.y.pos),
